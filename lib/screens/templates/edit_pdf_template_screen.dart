// ============================================================
//  EditPdfTemplateScreen — محرر القالب (سحب المربع + Sliders)
// ============================================================
...
class _EditPdfTemplateScreenState extends State<EditPdfTemplateScreen> {
  ...
  Future<void> _saveTemplate() async {
    ...
    try {
      ...
      // قراءة الصورة بشكل غير متزامن لمنع تجميد الواجهة
      final imageBytes = await _imageFile!.readAsBytes();
      final decodedImage = await decodeImageFromList(imageBytes);
      final imageWidth = decodedImage.width.toDouble();
      final imageHeight = decodedImage.height.toDouble();

      // نسخ الصورة إلى مجلد التطبيق لضمان بقائها
      final appDir = await getApplicationDocumentsDirectory();
      final fileName =
          'template_${DateTime.now().millisecondsSinceEpoch}_${p.basename(_imageFile!.path)}';
      ...
      await PdfTemplateService().saveTemplate(newTemplate);
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onPanUpdate: (details) {
                              ...
                              final constrainedDx = newOffset.dx
                                  .clamp(0.0, renderBox.size.width);
